...
We now work to show that $\PGL_2(\mathbb{R})$ acts $3$-transitively on $\Proj^1(\mathbb{R})$. Let's first prove that the action is transitive.  Let $r,s\in \Proj^1(\mathbb{R})$. If $r,s \in \mathbb{R}$, then 
